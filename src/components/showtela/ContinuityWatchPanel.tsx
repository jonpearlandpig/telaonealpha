  ...
  return (
    <section className="rounded-[24px] border border-[#D8C59D] bg-[#17130F] px-4 py-4 text-[#F8F1E2] shadow-[0_18px_38px_rgba(20,16,12,0.18)]">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#D7BC7F]">Continuity Watch</p>
          <h2 className="mt-1 text-[18px] font-semibold leading-tight">Operational heartbeat</h2>
        </div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        ...
        <div className="rounded-[14px] border border-white/10 bg-white/[0.06] px-3 py-2">
          <p className="text-[9px] font-semibold uppercase tracking-[0.12em] text-[#B7A889]">Decay</p>
      ...
      <div className="mt-4 rounded-[16px] border border-[#D7BC7F]/20 bg-[#241C14] px-3 py-3">
        ...
        <p className="mt-1 text-[12px] leading-relaxed text-[#D8CDB8]">{listLine(watch.upcomingRisk, 'No upcoming risk derived yet.')}</p>
      </div>
    </section>
  )
}
