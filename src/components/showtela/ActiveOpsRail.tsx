...
type ActiveOpsRailProps =
  | { people: PersonEntity[]; onSelect?: (person: PersonEntity) => void }
  | { items: Array<{ id: string; name: string; latest?: string; unresolvedCount: number; image: string }>; onSelect?: (person: PersonEntity) => void }

export function ActiveOpsRail(props: ActiveOpsRailProps) {
